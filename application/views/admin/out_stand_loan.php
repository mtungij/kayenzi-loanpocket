...
<div class="kt-portlet kt-portlet--mobile">
	...
	<div class="kt-portlet__head-actions">
		...
		<!-- <a href="<?php //echo base_url("admin/print_pending_report"); ?>" class="btn btn-brand btn-elevate btn-icon-sm" target="_blank">
		 ...
		 <a href="" class="btn btn-info" class="kt-nav__link" data-toggle="modal" data-target="#kt_modal_5"><i class="kt-menu__link-icon flaticon2-search-1"></i>Filter by brach</a>
	</div>	
</div>		</div>
	</div>
