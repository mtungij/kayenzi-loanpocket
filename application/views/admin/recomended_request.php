			...
			<div class="dropdown-menu dropdown-menu-right">
				<ul class="kt-nav">
					...
					<!-- <li class="kt-nav__item">
						<a href="#" class="kt-nav__link" data-toggle="modal" data-target="#kt_modal_1<?php //echo $datas->req_id; ?><?php //echo $datas->blanch_id; ?>">
    ...
    <div class="modal-dialog modal-xs" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Filter Expenses by</h5>
